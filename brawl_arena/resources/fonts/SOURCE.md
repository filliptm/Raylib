...
- Barlow Regular, Barlow Semibold, and Barlow Condensed Bold are from the
  [Barlow project](https://github.com/jpt/barlow), mirrored through the
  [Google Fonts repository](https://github.com/google/fonts/tree/main/ofl/barlow).
- IBM Plex Mono Medium is from the
  [IBM Plex project](https://github.com/IBM/plex), mirrored through the
  [Google Fonts repository](https://github.com/google/fonts/tree/main/ofl/ibmplexmono).
